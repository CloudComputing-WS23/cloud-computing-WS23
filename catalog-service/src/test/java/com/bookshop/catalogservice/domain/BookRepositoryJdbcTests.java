...
class BookRepositoryJdbcTests {
    ...
    @Test
    void findAllBooks() {
        var book1 = Book.of("1234561235", "Title", "Author", 12.90, "Manning Publications Co.");
        var book2 = Book.of("1234561236", "Another Title", "Author", 12.90, "Manning Publications Co.");
    ...
    void findBookByIsbnWhenExisting() {
        ...
        var book = Book.of(bookIsbn, "Title", "Author", 12.90, "Manning Publications Co.");
    ...
    void existsByIsbnWhenExisting() {
        ...
        var bookToCreate = Book.of(bookIsbn, "Title", "Author", 12.90, "Manning Publications Co.");
