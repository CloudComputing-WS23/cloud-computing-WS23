...
class CatalogServiceApplicationTests {
    ...
    void whenGetRequestWithIdThenBookReturned() {
		...
		var bookToCreate = Book.of(bookIsbn, "Title", "Author", 9.90, "Manning Publications Co.");
    ...
    void whenPostRequestThenBookCreated() {
        var expectedBook = Book.of("1231231231", "Title", "Author", 9.90, "Manning Publications Co.");
